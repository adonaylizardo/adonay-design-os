 ...
 * Usage: design comment [project-slug] [--dry-run]
 */
...
function printSetupInstructions() {
  ...
  console.log('   design comment <project-slug>');
  console.log('');
}
...
console.log('');
console.log('💬 Adonay Design OS Comment');
...
if (!commentsContent) {
  ...
  console.error('');
  console.error(`Run: design review ${slug}`);
  process.exit(1);
}
